...
public:
  ...
  enum {
    ...
    RuleGenericAssociation = 3, RuleTreeSetKey = 4, RuleTreeAddKey = 5, 
    RuleTreeGetKey = 6, RuleTreeFindKey = 7, RuleTreeEnum = 8, RuleFuncCall = 9, 
    RulePostfixExpression = 10, RuleArgumentExpressionList = 11, RuleUnaryExpression = 12, 
    RuleUnaryOperator = 13, RuleCastExpression = 14, RuleMultiplicativeExpression = 15, 
    RuleAdditiveExpression = 16, RuleShiftExpression = 17, RuleRelationalExpression = 18, 
    RuleEqualityExpression = 19, RuleAndExpression = 20, RuleExclusiveOrExpression = 21, 
    RuleInclusiveOrExpression = 22, RuleLogicalAndExpression = 23, RuleLogicalOrExpression = 24, 
    RuleConditionalExpression = 25, RuleAssignmentExpression = 26, RuleAssignmentOperator = 27, 
    RuleExpression = 28, RuleConstantExpression = 29, RuleDeclaration = 30, 
    RuleDeclarationSpecifiers = 31, RuleDeclarationSpecifiers2 = 32, RuleDeclarationSpecifier = 33, 
    RuleInitDeclaratorList = 34, RuleInitDeclarator = 35, RuleStorageClassSpecifier = 36, 
    RuleTypeSpecifier = 37, RuleStructOrUnionSpecifier = 38, RuleStructOrUnion = 39, 
    RuleStructDeclarationList = 40, RuleStructDeclaration = 41, RuleSpecifierQualifierList = 42, 
    RuleStructDeclaratorList = 43, RuleStructDeclarator = 44, RuleEnumSpecifier = 45, 
    RuleEnumeratorList = 46, RuleEnumerator = 47, RuleEnumerationConstant = 48, 
    RuleAtomicTypeSpecifier = 49, RuleTypeQualifier = 50, RuleFunctionSpecifier = 51, 
    RuleAlignmentSpecifier = 52, RuleDeclarator = 53, RuleDirectDeclarator = 54, 
    RuleGccDeclaratorExtension = 55, RuleGccAttributeSpecifier = 56, RuleGccAttributeList = 57, 
    RuleGccAttribute = 58, RuleNestedParenthesesBlock = 59, RulePointer = 60, 
    RuleTypeQualifierList = 61, RuleParameterTypeList = 62, RuleParameterList = 63, 
    RuleParameterDeclaration = 64, RuleIdentifierList = 65, RuleTypeName = 66, 
    RuleAbstractDeclarator = 67, RuleDirectAbstractDeclarator = 68, RuleTypedefName = 69, 
    RuleInitializer = 70, RuleInitializerList = 71, RuleDesignation = 72, 
    RuleDesignatorList = 73, RuleDesignator = 74, RuleStaticAssertDeclaration = 75, 
    RuleStatement = 76, RuleLabeledStatement = 77, RuleCompoundStatement = 78, 
    RuleBlockItemList = 79, RuleBlockItem = 80, RuleExpressionStatement = 81, 
    RuleSelectionStatement = 82, RuleIterationStatement = 83, RuleForCondition = 84, 
    RuleForDeclaration = 85, RuleForExpression = 86, RuleJumpStatement = 87, 
    RuleCompilationUnit = 88, RuleTranslationUnit = 89, RuleExternalDeclaration = 90, 
    RuleFunctionDefinition = 91, RuleDeclarationList = 92
  };
  ...
  class TreeSetKeyContext;
  class TreeAddKeyContext;
  class TreeGetKeyContext;
  class TreeFindKeyContext;
  class TreeEnumContext;
  ...
  class  TreeSetKeyContext : public antlr4::ParserRuleContext {
  public:
    TreeSetKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  TreeSetKeyContext* treeSetKey();

  class  TreeAddKeyContext : public antlr4::ParserRuleContext {
  public:
    TreeAddKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Tree_add_key();
  ...
  TreeAddKeyContext* treeAddKey();

  class  TreeGetKeyContext : public antlr4::ParserRuleContext {
  public:
    TreeGetKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  TreeGetKeyContext* treeGetKey();

  class  TreeFindKeyContext : public antlr4::ParserRuleContext {
  public:
    TreeFindKeyContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Tree_find_key();
    std::vector<antlr4::tree::TerminalNode *> Identifier();
    antlr4::tree::TerminalNode* Identifier(size_t i);
    antlr4::tree::TerminalNode *StringLiteral();
    antlr4::tree::TerminalNode *Constant();
  ...
  TreeFindKeyContext* treeFindKey();

  class  TreeEnumContext : public antlr4::ParserRuleContext {
  public:
    TreeEnumContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *Tree_enum();
    std::vector<antlr4::tree::TerminalNode *> Identifier();
    antlr4::tree::TerminalNode* Identifier(size_t i);
