...
public:
  ...
  virtual void enterTreeSetKey(CParser::TreeSetKeyContext *ctx) = 0;
  virtual void exitTreeSetKey(CParser::TreeSetKeyContext *ctx) = 0;

  virtual void enterTreeAddKey(CParser::TreeAddKeyContext *ctx) = 0;
  virtual void exitTreeAddKey(CParser::TreeAddKeyContext *ctx) = 0;

  virtual void enterTreeGetKey(CParser::TreeGetKeyContext *ctx) = 0;
  virtual void exitTreeGetKey(CParser::TreeGetKeyContext *ctx) = 0;

  virtual void enterTreeFindKey(CParser::TreeFindKeyContext *ctx) = 0;
  virtual void exitTreeFindKey(CParser::TreeFindKeyContext *ctx) = 0;

  virtual void enterTreeEnum(CParser::TreeEnumContext *ctx) = 0;
  virtual void exitTreeEnum(CParser::TreeEnumContext *ctx) = 0;

  virtual void enterFuncCall(CParser::FuncCallContext *ctx) = 0;
  virtual void exitFuncCall(CParser::FuncCallContext *ctx) = 0;
