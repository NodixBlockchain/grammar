...
public:
  ...
  virtual antlrcpp::Any visitTreeSetKey(CParser::TreeSetKeyContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitTreeAddKey(CParser::TreeAddKeyContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitTreeGetKey(CParser::TreeGetKeyContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitTreeFindKey(CParser::TreeFindKeyContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitTreeEnum(CParser::TreeEnumContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual antlrcpp::Any visitFuncCall(CParser::FuncCallContext *ctx) override {
    return visitChildren(ctx);
  }
