...
public:
   ...
   */
    ...
    virtual antlrcpp::Any visitTreeSetKey(CParser::TreeSetKeyContext *context) = 0;

    virtual antlrcpp::Any visitTreeAddKey(CParser::TreeAddKeyContext *context) = 0;

    virtual antlrcpp::Any visitTreeGetKey(CParser::TreeGetKeyContext *context) = 0;

    virtual antlrcpp::Any visitTreeFindKey(CParser::TreeFindKeyContext *context) = 0;

    virtual antlrcpp::Any visitTreeEnum(CParser::TreeEnumContext *context) = 0;

    virtual antlrcpp::Any visitFuncCall(CParser::FuncCallContext *context) = 0;
